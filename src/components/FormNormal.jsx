...
export default function FormNormal({ dispatch }) {
  ...
  const validateForm = () => {
    ...
    if (standardDeviation <= 0) {
      newErrors.push('El valor de la desviación estándar debe ser un número positivo.');
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 bg-gray-800 text-white rounded-md">
      ...
      <div className="mb-2">
        <label className="block">Desviación típica:</label>
        <input
          type="number"
